...
7. [Dicionário de siglas, Documentos Estratégicos Relacionados, Referências Bibliográficas & Normativas e Observações Finais](#7-referências-e-documentos-relacionados)
8. [Navegação Rápida (Links Internos)](#8-navegação)
...
Ele integra o conjunto de instrumentos de governança digital propostos pelo Departamento de Dados e Estatística (DADOS), em articulação com o MI-2025-006 — *Encaminhamento ao Diretor da DITI*, disponível no mesmo repositório.
...
| **Segurança e Backup** | Monitoramento e Proteção de Dados | Políticas de antivírus, firewall e cópias de segurança. | serviço contínuo | via equipe de Infra |
